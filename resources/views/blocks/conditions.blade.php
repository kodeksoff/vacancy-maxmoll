                ...
                <div class="section-content__right">
                    <div class="conditions-item">
                        <div class="conditions-item__icon">
                            <img src="img/item-icon_1.svg" alt="item1">
                        </div>
                        <div class="conditions-item__title">
                            Возможность карьерного роста
                        </div>
                        <div class="conditions-item__description">
                            Компания за 5 лет выросла с 3 до 120 человек и продолжает расти, что дает возможность
                            активно двигаться по карьерной лестнице.
                        </div>
                    </div>
                    <div class="conditions-item">
                        <div class="conditions-item__icon">
